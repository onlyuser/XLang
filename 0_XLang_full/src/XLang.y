...
#define MAKE_STRING(...) mvc::MVCModel::make_leaf<node::NodeBase::STRING>(pc, ID_STRING, ##__VA_ARGS__)
#define MAKE_CHAR(...) mvc::MVCModel::make_leaf<node::NodeBase::CHAR>(pc, ID_CHAR, ##__VA_ARGS__)
