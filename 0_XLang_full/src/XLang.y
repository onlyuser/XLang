...
statement:
    ...
    | ID_IDENT '=' expression { $$ = mvc::Model::make_inner(pc, '=', @$, 2,
                                        mvc::Model::make_leaf<node::NodeBase::IDENT>(pc, ID_IDENT, @$, $1), $3); }
    ;

expression:
      ID_INT                    { $$ = mvc::Model::make_leaf<node::NodeBase::INT>(pc, ID_INT, @$, $1); }
    | ID_FLOAT                  { $$ = mvc::Model::make_leaf<node::NodeBase::FLOAT>(pc, ID_FLOAT, @$, $1); }
    | ID_STRING                 { $$ = mvc::Model::make_leaf<node::NodeBase::STRING>(pc, ID_STRING, @$, *$1); }
    | ID_CHAR                   { $$ = mvc::Model::make_leaf<node::NodeBase::CHAR>(pc, ID_CHAR, @$, $1); }
    | ID_IDENT                  { $$ = mvc::Model::make_leaf<node::NodeBase::IDENT>(pc, ID_IDENT, @$, $1); }
