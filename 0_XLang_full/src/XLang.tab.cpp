...
{
      19,     0,    -1,    20,    -1,     1,    -1,    21,    -1,    21,
      14,    20,    -1,    22,    -1,     8,    15,    22,    -1,     4,
      -1,     5,    -1,     6,    -1,     7,    -1,     8,    -1,    22,
       9,    22,    -1,    22,    10,    22,    -1,    22,    11,    22,
      -1,    22,    12,    22,    -1,    16,    22,    17,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,   137,   137,   138,   142,   143,   147,   148,   152,   153,
...
{
  "$end", "error", "$undefined", "ID_BASE", "ID_INT", "ID_FLOAT",
  "ID_STRING", "ID_CHAR", "ID_IDENT", "'+'", "'-'", "'*'", "'/'",
  "ID_COUNT", "','", "'='", "'('", "')'", "$accept", "root", "program",
...
{
       0,     3,     8,     9,    10,    11,    12,     0,     0,     2,
       4,     6,     0,    12,     0,     1,     0,     0,     0,     0,
       0,     7,    17,     5,    13,    14,    15,    16
};
...
{
      -1,   -11,   -11,   -11,   -11,   -11,    17,    18,    14,   -11,
       2,    26,    18,   -11,     0,   -11,    23,    18,    18,    18,
      18,    26,   -11,   -11,   -10,   -10,   -11,   -11
};
...
{
       1,    19,    20,     2,     3,     4,     5,     6,    14,    17,
      18,    19,    20,    21,    15,     7,    16,    22,    24,    25,
      26,    27,     2,     3,     4,     5,    13,     2,     3,     4,
       5,     6,    12,     0,     7,    17,    18,    19,    20,     7,
      23
};

static const yytype_int8 yycheck[] =
{
       1,    11,    12,     4,     5,     6,     7,     8,     7,     9,
      10,    11,    12,    12,     0,    16,    14,    17,    17,    18,
      19,    20,     4,     5,     6,     7,     8,     4,     5,     6,
       7,     8,    15,    -1,    16,     9,    10,    11,    12,    16,
      16
};
...
{
       0,     1,     4,     5,     6,     7,     8,    16,    19,    20,
      21,    22,    15,     8,    22,     0,    14,     9,    10,    11,
      12,    22,    17,    20,    22,    22,    22,    22
};
...
do								\
  if (yychar == YYEMPTY && yylen == 1)				\
    ...
    {								\
      yyerror (&yylloc, pc, scanner, YY_("syntax error: cannot back up")); \
      YYERROR;							\
    }								\
while (YYID (0))
  ...
  if (yydebug)								  \
    {									  \
      ...
      yy_symbol_print (stderr,						  \
		  Type, Value, Location, pc, scanner); \
      YYFPRINTF (stderr, "\n");						  \
    }									  \
} while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, ParserContext* pc, yyscan_t scanner)
#else
static void
yy_symbol_value_print (yyoutput, yytype, yyvaluep, yylocationp, pc, scanner)
    FILE *yyoutput;
    int yytype;
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, ParserContext* pc, yyscan_t scanner)
#else
static void
yy_symbol_print (yyoutput, yytype, yyvaluep, yylocationp, pc, scanner)
    FILE *yyoutput;
    int yytype;
    YYSTYPE const * const yyvaluep;
    YYLTYPE const * const yylocationp;
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, ParserContext* pc, yyscan_t scanner)
#else
static void
yy_reduce_print (yyvsp, yylsp, yyrule, pc, scanner)
    YYSTYPE *yyvsp;
    YYLTYPE *yylsp;
    int yyrule;
    ParserContext* pc;
...
do {					\
  if (yydebug)				\
    yy_reduce_print (yyvsp, yylsp, Rule, pc, scanner); \
} while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, ParserContext* pc, yyscan_t scanner)
#else
static void
yydestruct (yymsg, yytype, yyvaluep, yylocationp, pc, scanner)
    const char *yymsg;
    int yytype;
    YYSTYPE *yyvaluep;
    YYLTYPE *yylocationp;
...
#else /* ! YYPARSE_PARAM */
#if defined __STDC__ || defined __cplusplus
int yyparse (ParserContext* pc, yyscan_t scanner);
#else
int yyparse ();
#endif
#endif /* ! YYPARSE_PARAM */
...
yyparse (YYPARSE_PARAM)
    void *YYPARSE_PARAM;
     ...
     || defined __cplusplus || defined _MSC_VER)
int
yyparse (ParserContext* pc, yyscan_t scanner)
#else
int
yyparse (pc, scanner)
    ParserContext* pc;
...
/* Line 1455 of yacc.c  */
#line 137 "src/XLang.y"
    { pc->tree_context().root() = (yyvsp[(1) - (1)].inner_value); ;}
    break;

  case 3:

/* Line 1455 of yacc.c  */
#line 138 "src/XLang.y"
...
/* Line 1455 of yacc.c  */
#line 142 "src/XLang.y"
    { (yyval.inner_value) = (yyvsp[(1) - (1)].inner_value); ;}
    break;

  case 5:

/* Line 1455 of yacc.c  */
#line 143 "src/XLang.y"
    { (yyval.inner_value) = MAKE_INNER(',', (yyloc), 2, (yyvsp[(1) - (3)].inner_value), (yyvsp[(3) - (3)].inner_value)); ;}
    break;

  case 6:

/* Line 1455 of yacc.c  */
#line 147 "src/XLang.y"
    { (yyval.inner_value) = (yyvsp[(1) - (1)].inner_value); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 148 "src/XLang.y"
    { (yyval.inner_value) = MAKE_INNER('=', (yyloc), 2, MAKE_LEAF(ID_IDENT, (yyloc), (yyvsp[(1) - (3)].ident_value)), (yyvsp[(3) - (3)].inner_value)); ;}
    break;

  case 8:

/* Line 1455 of yacc.c  */
#line 152 "src/XLang.y"
    { (yyval.inner_value) = MAKE_LEAF(ID_INT, (yyloc), (yyvsp[(1) - (1)].int_value)); ;}
    break;

  case 9:

/* Line 1455 of yacc.c  */
#line 153 "src/XLang.y"
    { (yyval.inner_value) = MAKE_LEAF(ID_FLOAT, (yyloc), (yyvsp[(1) - (1)].float_value)); ;}
    break;

  case 10:

/* Line 1455 of yacc.c  */
#line 154 "src/XLang.y"
    { (yyval.inner_value) = MAKE_LEAF(ID_STRING, (yyloc), *(yyvsp[(1) - (1)].string_value)); ;}
    break;

  case 11:

/* Line 1455 of yacc.c  */
#line 155 "src/XLang.y"
    { (yyval.inner_value) = MAKE_LEAF(ID_CHAR, (yyloc), (yyvsp[(1) - (1)].char_value)); ;}
    break;

  case 12:

/* Line 1455 of yacc.c  */
#line 156 "src/XLang.y"
    { (yyval.inner_value) = MAKE_LEAF(ID_IDENT, (yyloc), (yyvsp[(1) - (1)].ident_value)); ;}
    break;

  case 13:

/* Line 1455 of yacc.c  */
#line 157 "src/XLang.y"
    { (yyval.inner_value) = MAKE_INNER('+', (yyloc), 2, (yyvsp[(1) - (3)].inner_value), (yyvsp[(3) - (3)].inner_value)); ;}
    break;
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (&yylloc, pc, scanner, YY_("syntax error"));
#else
      {
	...
	if (0 < yysize && yysize <= yymsg_alloc)
	  {
	    ...
	    yyerror (&yylloc, pc, scanner, yymsg);
	  }
	else
	  {
	    yyerror (&yylloc, pc, scanner, YY_("syntax error"));
  ...
  if (yyerrstatus == 3)
      ...
      else
	{
	  yydestruct ("Error: discarding",
		      yytoken, &yylval, &yylloc, pc, scanner);
	  yychar = YYEMPTY;
	}
    }
  ...
  for (;;)
	...
	YYABORT;
      ...
      yydestruct ("Error: popping",
		  yystos[yystate], yyvsp, yylsp, pc, scanner);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (&yylloc, pc, scanner, YY_("memory exhausted"));
  yyresult = 2;
  /* Fall through.  */
#endif
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
		  yystos[*yyssp], yyvsp, yylsp, pc, scanner);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
