...
do								\
  if (yychar == YYEMPTY && yylen == 1)				\
    ...
    {								\
      yyerror (pc, scanner, YY_("syntax error: cannot back up")); \
      YYERROR;							\
    }								\
while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, ParserContext* pc, yyscan_t scanner)
#else
static void
yy_symbol_value_print (yyoutput, yytype, yyvaluep, pc, scanner)
    FILE *yyoutput;
    int yytype;
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, ParserContext* pc, yyscan_t scanner)
#else
static void
yy_symbol_print (yyoutput, yytype, yyvaluep, pc, scanner)
    FILE *yyoutput;
    int yytype;
    YYSTYPE const * const yyvaluep;
    ParserContext* pc;
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, int yyrule, ParserContext* pc, yyscan_t scanner)
#else
static void
yy_reduce_print (yyvsp, yyrule, pc, scanner)
    YYSTYPE *yyvsp;
    int yyrule;
    ParserContext* pc;
    yyscan_t scanner;
...
do {					\
  if (yydebug)				\
    yy_reduce_print (yyvsp, Rule, pc, scanner); \
} while (YYID (0))
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, ParserContext* pc, yyscan_t scanner)
#else
static void
yydestruct (yymsg, yytype, yyvaluep, pc, scanner)
    const char *yymsg;
    int yytype;
    YYSTYPE *yyvaluep;
    ParserContext* pc;
...
/* Line 1455 of yacc.c  */
#line 125 "src/XLang.y"
    { (yyval.inner_value) = MAKE_INNER(',', 2, (yyvsp[(1) - (3)].inner_value), (yyvsp[(3) - (3)].inner_value)); ;}
    break;

  case 6:

/* Line 1455 of yacc.c  */
#line 129 "src/XLang.y"
    { (yyval.inner_value) = (yyvsp[(1) - (1)].inner_value); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 130 "src/XLang.y"
    { (yyval.inner_value) = MAKE_INNER('=', 2, MAKE_LEAF(ID_IDENT, (yyvsp[(1) - (3)].ident_value)), (yyvsp[(3) - (3)].inner_value)); ;}
    break;

  case 8:

/* Line 1455 of yacc.c  */
#line 134 "src/XLang.y"
...
#line 136 "src/XLang.y"
    { (yyval.inner_value) = MAKE_LEAF(ID_IDENT, (yyvsp[(1) - (1)].ident_value)); ;}
    break;
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (pc, scanner, YY_("syntax error"));
#else
      {
  ...
  for (;;)
	...
	YYABORT;
      ...
      yydestruct ("Error: popping",
		  yystos[yystate], yyvsp, pc, scanner);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (pc, scanner, YY_("memory exhausted"));
  yyresult = 2;
  /* Fall through.  */
#endif
