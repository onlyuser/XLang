...
int _XLANG_lex()
{
    ...
    if (isalpha(*yytext) || '_' == *yytext)
    {
        ...
        _XLANG_lval.name = parse_context()->get_insert_name(yytext);
        return ID_IDENT;
    }
...
expression:
      ID_FLOAT                  { $$ = mvc::Model::make_value(parse_context(), ID_FLOAT, $1); }
