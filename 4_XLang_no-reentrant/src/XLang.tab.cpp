...
{
       0,   123,   123,   124,   128,   129,   133,   134,   138,   139,
...
/* Line 1455 of yacc.c  */
#line 123 "src/XLang.y"
    { parser_context()->tree_context().root() = (yyvsp[(1) - (1)].inner_value); ;}
    break;
