...
#define MAKE_LEAF(sym_id, ...) xl::mvc::MVCModel::make_leaf(&parser_context()->tree_context(), sym_id, ##__VA_ARGS__)
#define MAKE_INNER(...) xl::mvc::MVCModel::make_inner(&parser_context()->tree_context(), ##__VA_ARGS__)
